      ...
      <div className="container px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1 md:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold text-white">NetSaas</span>
            </div>
            <p className="text-sm">
              Enterprise-grade SaaS platform powered by .NET 8 with secure OIDC authentication.
            </p>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/docs" className="text-sm hover:text-white transition-colors">Documentation</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/docs/api" className="text-sm hover:text-white transition-colors">API Reference</a></li>
              <li><a href="/docs/oidc" className="text-sm hover:text-white transition-colors">OIDC Integration</a></li>
              <li><a href="/docs/dotnet" className="text-sm hover:text-white transition-colors">.NET 8 Guide</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1">
            ...
            <ul className="space-y-2">
              ...
              <li><a href="/legal" className="text-sm hover:text-white transition-colors">Legal</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800 flex flex-col md:flex-row justify-between items-center">
          <p className="text-sm text-gray-400">
            &copy; {new Date().getFullYear()} NetSaas. All rights reserved.
          </p>
